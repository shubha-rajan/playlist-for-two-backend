...
class TestRecommendations(TestCase):
    ...
    def test_get_recommendations(self):
        ...
        recommendations = playlist_generation.get_rec_from_intersection(self.intersection, False)
    ...
    def test_explicit_filter(self):
        ...
        result = playlist_generation.get_rec_from_intersection(self.intersection, True)
