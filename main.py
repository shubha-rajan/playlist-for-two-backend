...
def create_new_playlist():
    ...
    seeds = request.form.get('seeds') if json.loads(request.form.get('seeds')) else None
    features = request.form.get('features') if json.loads(request.form.get('features')) else None
