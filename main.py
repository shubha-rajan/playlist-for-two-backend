...
def create_new_playlist():
    ...
    seeds = json.loads(request.form.get('seeds')) if request.form.get('seeds')  else None
    features = json.loads(request.form.get('features')) if request.form.get('features') else None
